...
if [ $RET != 0 ] && [ $DEBARCH != "riscv64" ]; then
    ...
    DEBOOTSTRAP_PARAMS="--keyring /usr/share/keyrings/debian-archive-removed-keys.gpg $DEBOOTSTRAP_PARAMS https://mirrors.aliyun.com/debian/" # https://archive.debian.org/debian-archive/debian/"
...
echo "DiGouShu" | sudo tee $DIR/etc/hostname
